...
/**
 * Created by thaciana on 14/01/2016.
 */
public class PSM implements Measurable {

    public static final String NAME = "Presence of synchronous messages";
    private static final String XPATH_QUERY = "count(//message[@*=\"uml:Message\"][@messageSort=\"synchCall\"])";
